...
# Friendly GET message on /webhook
@app.get("/webhook")
async def webhook_get():
    return {
        "status": "This endpoint only accepts POST requests from Telegram updates.",
        "info": "Do not visit this in a browser to test your bot."
    }
